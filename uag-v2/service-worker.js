const CACHE = 'lm-pilot-pro-uag-v2-cache-1';
const PREFIX = 'lm-pilot-pro-uag-v2-';
const SHELL = ['./','./index.html','./manifest.webmanifest','./offline.html','../uag/icon-uag.svg','../uag/icon-uag-192.png','../uag/icon-uag-512.png','../uag/splash-lm-pilot-pro-uag.jpg'];
